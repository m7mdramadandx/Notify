object Libs {
    ...
    const val composeMaterialIconsExt = "androidx.compose.material:material-icons-extended:1.1.1"
    ...
    const val locationServices = "com.google.android.gms:play-services-location:20.0.0"
